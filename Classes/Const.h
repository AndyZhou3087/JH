...
"温度过低，会让你的内伤加重，记得低温时受了内伤尽快治疗！", "可以在客栈里跟韦小宝进行交易，每日交易的物品都有不同哦~","结交好友可获得属性的加成，好友多多益善！","拜师可以获得专属武功的加成，拜师只能选择一个哦！",
"武道大会复活后可继续挑战，不需要重新开始。", "结交好友后会触发随机事件，千万要谨慎选择好友！", "在山间行走时有机会遇到藏宝悬崖，可遇不可求哦！"
};
...
static std::string LOGINREWARDS[] = { "12001", "w001", "g2", "x001", "12003", "80004", "g10" };
