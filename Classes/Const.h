...
static std::string herofightdesc2[15] = { "%s被震的向后退了几步，差点倒在地上，受到了%d点伤害。","%s哇哇吐出一堆鲜血。受到了%d点伤害。","%s似乎受到了重击，已经摇摇欲坠，受到了%d点伤害。", "%s单膝跪地，粗气连连，似乎耗费了很多力气，受到了%d点伤害。", "%s以剑挡格，铮的一声响，武器相击，嗡嗡作声，长剑猛地击落" ,
