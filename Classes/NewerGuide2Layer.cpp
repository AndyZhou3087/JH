...
{ "想不到这么快你就获得其它侠客的武功了", "那是自然！", "我来教你武功组合吧，可以组合成神功哦！", "武功组合？那是个什么东西？", "顾名思义，就是两个不同的武功可以组合成一个新的武功！但是千万不要随意尝试，小心走火入魔！", "这么厉害？那快告诉我怎么组合！", "首先你要把两个以上的武功升到满级，然后在武功组合界面，主武功下选择武功，副武功处放置武功，然后点击【确认组合】，组合成功后，把主武功装备到你的武功栏就可以使用了！", "原来如此！这么简单？好！那我就先去练功了" }
};
